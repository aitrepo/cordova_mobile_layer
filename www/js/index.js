var app = {
    ...
    onDeviceReady: function () {
        ...
        let PUBLIC_URI = "http://192.168.1.107:3000/booklist/";
        ...
        if (settingsPage || (window.localStorage.getItem("USER_PREF") == undefined && window.localStorage.getItem("USER_PREF") == null)) {
        ...
        function loadData(categories) {
            ...
            $.ajax({
                ...
                console.log("serice call : " + bookDetails.service)
